...
namespace POS
{
    public partial class NewProduct : Form
    {
        ...
        private void dgvChildItems_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
          
                
                    //int col = dgvChildItems.CurrentCell.ColumnIndex;
                    //int row = dgvChildItems.CurrentCell.RowIndex;

                    //if (e.RowIndex >= 0)
                    //{
                    //    if (col == 2)
                    //    {
                    //        int currentQty = Convert.ToInt32(dgvChildItems.Rows[row].Cells[2].Value);
                    //        if (currentQty == 0 || currentQty.ToString() == string.Empty)
                    //        {
                    //            //row.Cells[2].Value = "1";
                    //            MessageBox.Show("Please fill Quantity.");

                    //            dgvChildItems.Rows[row].Cells[2].Selected = true;
                    //            return;
                    //        }
                    //    }
